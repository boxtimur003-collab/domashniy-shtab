  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-md border-b dark:border-slate-700 sticky top-0 z-30">
        <div className="max-w-4xl mx-auto px-4 py-3 flex justify-between items-center pr-28">
          <h1 className="font-bold dark:text-white">🏠 {family.name}</h1>
          <button
            onClick={logout}
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border-t dark:border-slate-700 z-30">
        <div className="max-w-4xl mx-auto flex">
          {[
            { id: "home", label: "🏠 Статусы" },
            { id: "chats", label: "💬 Чаты" },
